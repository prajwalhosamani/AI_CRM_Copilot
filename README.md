...
An AI agent that answers natural-language questions about Salesforce CRM data by autonomously writing and executing SOQL queries, self-correcting on errors, and generating charts — built to demonstrate applied AI agent design on top of real enterprise CRM data.
